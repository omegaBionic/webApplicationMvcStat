    ...
    public partial class Startup
    {
        ...
        public void ConfigureAuth(IAppBuilder app)
        {
            ...
            app.UseFacebookAuthentication(
               appId: "2774554899282272",
              appSecret: "07afb15a22d48f33f6ec85bb4150d27d");

            app.UseGoogleAuthentication(new GoogleOAuth2AuthenticationOptions()
            {
                ClientId = "731483754974-aj7gsnk025cehrj4bd21k6ekdg6m86lq.apps.googleusercontent.com",
               ClientSecret = "3d5csrKm1jvbLXTDfSvvVhY9"
            });
        }
    }
}